...
@Component({
  selector: 'app-reduire-stock',
  templateUrl: './reduire-stock.component.html',
  styleUrls: ['./reduire-stock.component.css']
})
export class reduireStockComponent implements OnInit {
